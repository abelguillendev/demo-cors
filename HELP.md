...
* The original package name 'com.example.demo-cors' is invalid and this project uses 'com.example.demo_cors' instead.
...
```
$ docker run --rm -p 8080:8080 demo-cors:0.0.1-SNAPSHOT
```
